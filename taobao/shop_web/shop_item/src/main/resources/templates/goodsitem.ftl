...
<div class="shop_goods_bd clear">
        ...
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')">
                    <!-- 放大镜的图片 -->
                    <IMG height="350" src="http://192.168.17.128:8080/${images[0]}" jqimg="images/img04.jpg" width="350">
                </div>
                <div id="spec-n5">
                    <div class=control id="spec-left">
                    <!-- 当前的大图 -->
                    <img src="http://192.168.17.128:8080/${images[0]}" />
                </div>
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list images as img>
                                <li><img src="http://192.168.17.128:8080/${img}"> </li>
                            </#list>
                        </ul>
                    </div>
    ...
    <script>
        ...
        function insertCart(){
            ...
            location.href = "http://192.168.17.1:8085/cart/insert?gid=" + gid + "&gnumber=" + gnumber;
        }
